...
class DynamicAgentPlugin : Plugin, IncomingMessageConsumerPlugin, CommandContributor,
    ...
    override val configDescription: String = "DeepSeek AI\u5bf9\u8bdd / Dota2\u6218\u62a5 / \u8054\u7f51\u641c\u7d22"
    ...
    override val configFormSpec = ConfigFormSpec(
        ...
        fields = listOf(
            ...
            ConfigFieldSpec("trigger.triggerPrefix", "\u89e6\u53d1\u524d\u7f00", ConfigFieldType.TEXT, section = "\u89e6\u53d1", description = "\u9ed8\u8ba4 /ds"),
            ConfigFieldSpec("trigger.enableAtTrigger", "\u542f\u7528 @Bot \u89e6\u53d1", ConfigFieldType.BOOLEAN, section = "\u89e6\u53d1"),
    ...
    private fun rebuildServices() {
        ...
        this.messageListener = MessageListener(
            ...
            dota2Service = dota2Service, dsClient = dsClient, imageConfig = config.image,
            pluginContext = context, dataDir = dataDir, cacheUtils = cacheUtils,
        ...
        this.commandHandlers = CommandHandlers(
            config = config, chatService = chatService, sessionManager = sessionManager,
            dota2Service = dota2Service, dsClient = dsClient, imageConfig = config.image,
            pluginContext = context, cacheUtils = cacheUtils, fontRegistry = fontRegistry,
        )
    }
    ...
    override suspend fun onIncomingMessage(ctx: IncomingMessageDispatchContext) {
        messageListener.handle(ctx)
    }
}
